...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    // Novo: filtros de busca em 2 modos (Erbon)
    searchByBookingTab:    'Por Reserva',
    searchByGuestTab:      'Por Dados do Hóspede',
    bookingNumberLabel:    'Número da Reserva',
    bookingNumberPlaceholder: 'Ex: 12345',
    bookingNumberHelp:     'Use o número informado na sua confirmação de reserva',
    surnameLabel:          'Sobrenome do Titular',
    surnamePlaceholder:    'Ex: Silva',
    checkinLabel:          'Check-in',
    checkoutLabel:         'Check-out',
    datePlaceholder:       'dd/mm/aaaa',
    notFoundByGuest:       'Não encontramos uma reserva com esses dados. Verifique sobrenome e datas.',
    invalidDate:           'Data inválida',
    invalidDateRange:      'A data de check-out deve ser igual ou posterior à de check-in',
    erbonOfflineUseBooking: 'Não foi possível consultar a reserva agora. Use a aba "Por Reserva" com o número da reserva para seguir com o check-in.',
    ...
    complementPlaceholder: 'Apto, bloco, casa',
    zipcodeField: 'CEP',
  ...
  en: {
    ...
    searchByBookingTab:    'By Booking',
    searchByGuestTab:      'By Guest Details',
    bookingNumberLabel:    'Booking Number',
    bookingNumberPlaceholder: 'Ex: 12345',
    bookingNumberHelp:     'Use the number from your reservation confirmation',
    surnameLabel:          'Holder Last Name',
    surnamePlaceholder:    'Ex: Smith',
    checkinLabel:          'Check-in',
    checkoutLabel:         'Check-out',
    datePlaceholder:       'dd/mm/yyyy',
    notFoundByGuest:       'No reservation found with these details. Check the last name and dates.',
    invalidDate:           'Invalid date',
    invalidDateRange:      'Check-out date must be on or after check-in',
    erbonOfflineUseBooking: 'We could not look up your reservation right now. Use the "By Booking" tab with your booking number to continue the check-in.',
    ...
    numberField: 'Number *', complementField: 'Unit / Complement',
    complementPlaceholder: 'Apt, block, house',
  ...
  es: {
    ...
    searchByBookingTab: 'Por Reserva',
    searchByGuestTab: 'Por Datos del Huésped',
    bookingNumberLabel: 'Número de Reserva',
    bookingNumberPlaceholder: 'Ej: 12345',
    bookingNumberHelp: 'Use el número de su confirmación de reserva',
    surnameLabel: 'Apellido del Titular',
    surnamePlaceholder: 'Ej: García',
    checkinLabel: 'Check-in',
    checkoutLabel: 'Check-out',
    datePlaceholder: 'dd/mm/aaaa',
    notFoundByGuest: 'No encontramos una reserva con esos datos. Verifique apellido y fechas.',
    invalidDate: 'Fecha inválida',
    invalidDateRange: 'La fecha de check-out debe ser igual o posterior al check-in',
    erbonOfflineUseBooking: 'No fue posible consultar la reserva en este momento. Use la pestaña "Por Reserva" con el número de reserva para continuar el check-in.',
    ...
    numberField: 'Número *', complementField: 'Complemento',
    complementPlaceholder: 'Depto, bloque, casa',
