/*
  # Fix Substituted Product Stock Updates

  1. Changes
    - Simplify trigger function to use a single code path
    - Add explicit error handling for stock updates
    - Add validation for product existence and stock availability
