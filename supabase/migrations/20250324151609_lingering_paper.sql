/*
  # Fix Product Quantity Change Trigger
...
DROP TRIGGER IF EXISTS handle_product_quantity_change ON products;
DROP FUNCTION IF EXISTS handle_product_quantity_change();
