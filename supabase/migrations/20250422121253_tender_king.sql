/*
  ...
  1. Changes
    - Add unit_value column for tracking transfer values
    - Add total_value column as a computed column
    - Add index for value queries
    
  2. Notes
    - unit_value stores the per-unit value of transferred products
    - total_value is automatically computed from quantity * unit_value
*/
