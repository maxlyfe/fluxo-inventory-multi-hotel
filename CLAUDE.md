...
`commercial`, `directors_dashboard`
...
| Diretoria | DirectorsDashboard, Comparison, KPIs | `directors_dashboard` |
| Portal | EmployeePortal, MySchedule, Events | `employee_portal` |
| Admin | UserMgmt, Roles, Sectors, WhatsApp, Erbon | `admin`, `users_management`, etc. |
